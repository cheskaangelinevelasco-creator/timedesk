...
<script>
    ...
    // (queries for counts are already set above; these reassignments were removed)
        const doughnutchart = {
          type: 'doughnut',
          data: data,
          options: {}
